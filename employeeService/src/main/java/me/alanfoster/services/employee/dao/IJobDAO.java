 ...
 * This DAO does not provide basic CRUD operations.
 *
 * @author Alan Foster
...
public interface IJobDAO extends IDAO {
    ...
    /**
     * Used to get a list of distinct jobTitles with an associated count
     * of employees which have that job title currently.
     *
