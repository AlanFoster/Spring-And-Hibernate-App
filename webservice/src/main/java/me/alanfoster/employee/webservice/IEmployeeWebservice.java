...
/**
 * This webservice offers the functionality to directly
 * manipulate employees that are persisted.
 *
 * @author Alan Foster
...
public interface IEmployeeWebservice {
     ...
     *
     * @param employeeId The employeeId key that is assigned
     *                   to each saved Employee object
     ...
     */
    void updateEmployee(
            @WebParam(name = "object") Employee employee);
